...
class vtkp:
  ...
  def manyGran(self,*args,**kwargs):
    ...
    while 1:
      ...
      file, file_bb, file_walls, file_egys = generateFilename(root,fileNos,n)
...
def generateFilename(root,fileNos,n):
  if fileNos[n] < 10:
    ...
    file_prof= root + "000" + str(fileNos[n]) + "_prof.csv"
  elif fileNos[n] < 100:
    ...
    file_prof= root + "00" + str(fileNos[n]) + "_prof.csv"
  elif fileNos[n] < 1000:
    ...
    file_prof= root + "0" + str(fileNos[n]) + "_prof.csv"
  else:
    ...
    file_prof= root + str(fileNos[n]) + "_prof.csv"

  return (file, file_bb, file_walls, file_egys)
